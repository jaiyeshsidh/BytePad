...
<template>
    <div>
            ...
            <div class="header-search-inner">
                <div id="input-holder">
                    <div class="branding">
                        ...
                        <h1>Bytepad
                            <p>Powered by SOFTWARE INCUBATOR</p>
                        </h1>
                    </div>
                    <div id="search-focus">
        ...
        <div id="dark-line">
            <h1 id="explore">
                <span style="color: #fe2b65;">BytePad</span> IN EVEry exam</h1>
        </div>
        ...
        <footer>
            <div class="container">
                <p>&copy; 2016 BYTEPAD.
                    <img src="asset/images/silogo.svg" class="img-responsive" id="svg-logo" style="display: inline; width: 40px;"> Developed and Designed By
                    <a id="id-link" href="http://silive.in/" target="_blank">SOFTWARE INCUBATOR.</a>
                </p>
            </div>
        </footer>
    </div>
